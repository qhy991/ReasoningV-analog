...
\end{itemize}
This mapping was derived from an analysis of error patterns in the validation set, where we identified specific question indices that benefited from different reasoning approaches.
